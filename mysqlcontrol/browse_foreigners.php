...
$userLogin = $_SESSION['logined'] ?? [];
session_write_close();
if(empty($userLogin) || !isset($userLogin['permision']) || $userLogin['permision'] != '1'){
    echo '
        <script>
            alert("You not have permision to access mysql control!\nOnly ADMIN have permision accept!");
